...
4. Set the plugin_folder variable in `.env.example` to point the correct folder and then rename the file to `.env` (the placeholder will be replaced in the next step).
