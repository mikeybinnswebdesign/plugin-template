...
First, Find the file named "phpstan-vscode.neon" in "src". When you have found that, copy it to "phpstan.neon". You can either delete or ignore the other editor files, but make sure you leave phpstan.dist.neon as this is required.
